// Skills section: orbit visual + skill columns
...
function Skills() {
  return (
    <section className="section skills" id="sec-skills" data-screen-label="03 Skills">
        ...
        <div className="skills__columns">
          <AppearOnScroll className="skill-col">
            ...
            <p className="skill-col__desc">
              Multiple front-end and full-stack projects using modern stacks. Strong sense of
              responsive, accessible, high-performance web interfaces, and comfortable wiring
              frontend to backend.
            </p>
          ...
          <AppearOnScroll delay={100} className="skill-col">
            ...
            <p className="skill-col__desc">
              ...
              pixel art, motion, and a design-first mindset focused on usability and
              aesthetics.
            </p>
            <div className="skill-chips">
              {["Figma", "Photoshop", "Illustrator", "After Effects", "Lightroom", "Piskel", "FL Studio", "CapCut"].map((s) => (
                <span key={s} className="skill-chip">{s}</span>
              ))}
            </div>
          </AppearOnScroll>
          ...
          <AppearOnScroll delay={200} className="skill-col">
            ...
            <p className="skill-col__desc">
              ...
              enhance usability and create seamless user experiences. See the Cosmic UI Kit
              project for a live sample.
            </p>
            <div className="skill-chips">
